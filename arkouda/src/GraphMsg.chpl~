module GraphMsg {
  ...
  proc segTriCentralityMsg(cmd: string, payload: string, st: borrowed SymTab): MsgTuple throws {
      var repMsg: string;
      var (n_verticesN, n_edgesN, directedN, weightedN, restpart) = payload.splitMsgToTuple(5);
      var Nv=n_verticesN:int;
      var Ne=n_edgesN:int;
  ...
  proc segTrussMsg(cmd: string, payload: string, st: borrowed SymTab): MsgTuple throws {
      ...
      proc kTrussNaive(k:int,nei:[?D1] int, start_i:[?D2] int,src:[?D3] int, dst:[?D4] int,
                        neiR:[?D11] int, start_iR:[?D12] int,srcR:[?D13] int, dstR:[?D14] int,TriCound:[?D5] int):string throws{
          var SetCurF=  new DistBag(int,Locales);//use bag to keep the current frontier
          var SetNextF=  new DistBag((int,int),Locales); //use bag to keep the next frontier
          var N1=0:int;
          var N2=0:int;
              ...
              coforall loc in Locales with ( ref SetNextF) {
                on loc {
                     ...
                     forall i in startEdge..endEdge with(ref SetCurF){
                         ...
                         /* the old code. to be removed if the up code is correct.
                         if ( du<=dv ) {
                         // here we search from the vertex who has small degree
                             //writeln("1 My Locale=",here.id," Current Edge=",i, "=<",u,",",v,">");
                             var beginTmp=start_i[u];
                      ...
                      on loc {
                           ...
                           forall i in SetCurF with (ref SetNextF) {
                              if (xlocal(i,startEdge,endEdge)) {//each local only check the owned edges
                                  ...
                                  /* to be removed if the up code is correct
                                  if (dv1<=dv2) {
                                      var nextStart=start_i[v1];
                                      var nextEnd=start_i[v1]+nei[v1]-1;
                                      if (nei[v1]>1) {
          ...
          if (kValue>0) {// k branch
                ...
                */
                ...
                repMsg=kTrussMix(kValue,ag.neighbour.a, ag.start_i.a,ag.src.a,ag.dst.a,
                               ag.neighbourR.a, ag.start_iR.a,ag.srcR.a,ag.dstR.a,AtoTriCount);
                /*
                ...
                */
                ...
                PTriCount=0;
                repMsg=TrussDecompositionListIntersection(3,ag.neighbour.a, ag.start_i.a,ag.src.a,ag.dst.a,
                               ag.neighbourR.a, ag.start_iR.a,ag.srcR.a,ag.dstR.a,PTriCount);
                ...
                */
                ...
                repMsg=TrussDecompositionMix(3,ag.neighbour.a, ag.start_i.a,ag.src.a,ag.dst.a,
                               ag.neighbourR.a, ag.start_iR.a,ag.srcR.a,ag.dstR.a,AtoTriCount);
          } else  {//k max branch
                ...
                repMsg=kTrussListIntersection(kLow,ag.neighbour.a, ag.start_i.a,ag.src.a,ag.dst.a,
                               ag.neighbourR.a, ag.start_iR.a,ag.srcR.a,ag.dstR.a,PTriCount);
                ...
                if ((AllRemoved==false) && (kUp>3)) {// k max >3
                    ...
                    while ( (ConLoop) && (kLow<kUp)) {
                         ...
                         AllRemoved=SkMaxTruss(kUp,ag.neighbour.a, ag.start_i.a,ag.src.a,ag.dst.a,
                               ag.neighbourR.a, ag.start_iR.a,ag.srcR.a,ag.dstR.a,PlTriCount);
                         //writeln("Try up=",kUp);
                ...
                // we first initialize the kmax from kLow=3
                repMsg=kTrussMix(kLow,ag.neighbour.a, ag.start_i.a,ag.src.a,ag.dst.a,
                                      ag.neighbourR.a, ag.start_iR.a,ag.srcR.a,ag.dstR.a,AtoTriCount);
                kUp=getupK(ag.neighbour.a, ag.neighbourR.a);
                //writeln("Max K Up=",kUp);
                if ((AllRemoved==false) && (kUp>3)) {// k max >3
                    ...
                    while ( (ConLoop) && (kLow<kUp)) {
                         ...
                         AllRemoved=SkMaxTrussMix(kUp,ag.neighbour.a, ag.start_i.a,ag.src.a,ag.dst.a,
                                                      ag.neighbourR.a, ag.start_iR.a,ag.srcR.a,ag.dstR.a,lAtoTriCount);
                         //writeln("Try up=",kUp);
                         if (AllRemoved==false) { //the up value is the max k
                                ConLoop=false;
                         } else {// we will check the mid value to reduce k max
                            ...
                            //writeln("Try mid=",kMid);
                            AllRemoved=SkMaxTrussMix(kMid,ag.neighbour.a, ag.start_i.a,ag.src.a,ag.dst.a,
                                                      ag.neighbourR.a, ag.start_iR.a,ag.srcR.a,ag.dstR.a,lAtoTriCount);
                            if (AllRemoved==true) { // if mid value can remove all edges, we will reduce the up value for checking
                                  kUp=kMid-1;
                            } else { // we will improve both low and mid value
